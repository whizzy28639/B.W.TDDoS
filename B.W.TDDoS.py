...
def show_intro():
    ...
    print("╠════════════════════════════════════════════════════════════╣")
    print("║ 👤 Name       : 𝐁・𝐖・𝐓                               ║")
    print("║ 🌐 Telegram Channel : t.me/+GaLEHJkMVodlODQ8                ║")
    print("║ ✞︎ 𝐁・𝐖・𝐓 developer : N5I4X                       ║")
...
def show_banner():
    ...
    print("""\033[95m
╔══════════════════════════════════════════════════════════╗
║         ☠️ 𝐁・𝐖・𝐓 DDOS v5 – WORLD BREAKER ☠️             ║
║  🔥 Coded by: 𝐁・𝐖・𝐓 | Proxy + Multi-Vector Engine 🔥    ║
╠══════════════════════════════════════════════════════════╣
║  🚀 Max Threads   : {:>8}                               ║
...
def start_ui():
    ...
    print("\033[96m")
    print("╔════════════════════════════════════════════╗")
    print("║        🔥 𝐁・𝐖・𝐓 DDOS TOOLKIT UI MENU 🔥    ║")
    print("╠════════════════════════════════════════════╣")
